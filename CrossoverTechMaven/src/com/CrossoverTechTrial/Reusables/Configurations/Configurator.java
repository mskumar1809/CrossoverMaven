   ...
   // We Can choose the below browsers as optional firefox/chrome/ie in setup method.
    ...
    public void setup(@Optional("chrome")String browser) throws Exception{
        if(browser.equalsIgnoreCase("firefox")){
        	...
        	System.setProperty("webdriver.gecko.driver","src\\com\\CrossoverTechTrial\\Reusables\\Supporters\\Utilities\\geckodriver.exe");
            ...
            System.setProperty("webdriver.chrome.driver","src\\com\\CrossoverTechTrial\\Reusables\\Supporters\\Utilities\\chromedriver.exe");
            ...
            System.setProperty("webdriver.ie.driver","src\\com\\CrossoverTechTrial\\Reusables\\Supporters\\Utilities\\IEDriverServer.exe");
